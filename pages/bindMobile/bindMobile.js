...
function postLoginData() {
  ...
  let url = app.config.apiUrl + 'api/user/binding/phone';
  let params = {
    remember_token: app.globalData.token,
    user_name: that.data.phoneNum,
    sms_code: that.data.verification
  }
  app.server.postRequest(url, params).then((data) => {
    ...
    if (data.status_code === 'success') {
      ...
      setTimeout(() => {
        ...
        let userInfo = app.globalData.storageUserInfo  // 本地缓存的数据
        userInfo.user_name = that.data.phoneNum
